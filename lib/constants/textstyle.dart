...
TextStyle whitetext = GoogleFonts.poppins(fontSize: 16,color:Color(0xffffffff));
TextStyle buttonwhitetext = GoogleFonts.poppins(fontSize: 14,color:Color(0xffffffff));
TextStyle whitetextbold = GoogleFonts.poppins(fontSize: 20,color:Color(0xffffffff),fontWeight: FontWeight.w500);
